...
<div style="text-align: center; display: flex; width: 100%; justify-content: space-evenly; align-items: center; gap: 1em; padding: 2em">
  <img style="width: 20%;" src="https://github.com/Open-Finance-Lab/ACM_ICAIF_2023/blob/main/web/app/assets/logos/acm.png?raw=true" alt="ACM Logo">
...
<div style="text-align: center; display: flex; width: 100%; justify-content: space-evenly; align-items: center; gap: 1em; padding: 2em">
  <img style="width: 20%;" src="https://github.com/Open-Finance-Lab/ACM_ICAIF_2023/blob/main/web/app/assets/logos/vatic.png?raw=true" alt="VATIC logo">
...
![figure1](https://github.com/Open-Finance-Lab/ACM_ICAIF_2023/blob/main/web/app/assets/figures/fig1.png?raw=true)
